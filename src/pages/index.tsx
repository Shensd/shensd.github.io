...
const LogoGithub="/logo-github.png";
const LogoMail="/logo-mail.png";
const AniSpiral="/spiral-single.gif";
...
const IndexPage = () => {
  return (
    <main>
        <Jumbotron>
            <h1>Jack Hance</h1>
            <PositionCarousel preface="" titles={["Developer", "Hacker", "Computer Enjoyer"]}/>
